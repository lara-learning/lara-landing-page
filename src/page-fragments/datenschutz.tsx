  ...
  return (
    <section className="bg-black text-white px-8 md:px-16 lg:px-32 pt-32 lg:pt-40 pb-20 lg:pb-28">
      ...
      <div className="w-full max-w-6xl mx-auto mt-16">
        ...
        <section className="mt-8 pb-16 lg:pb-20">
          <h2 className="text-3xl lg:text-5xl font-bold text-white mb-10 lg:mb-14">
            Welche Kategorien personenbezogener Daten erheben wir und wie
            verarbeiten wir diese personenbezogenen Daten?
          </h2>
        ...
        <section className="mt-8 pb-16 lg:pb-20">
          <h2 className="text-3xl lg:text-5xl font-bold text-white mb-10 lg:mb-14">
            Wie nutzen wir personenbezogene Daten bei Ihrem Besuch auf der
            Website von Lara?
          </h2>
        ...
        <section className="mt-8 pb-16 lg:pb-20">
          <h2 className="text-3xl lg:text-5xl font-bold text-white mb-10 lg:mb-14">
            Auf welche sonstige Art und Weise könnten wir Ihre personenbezogenen
            Daten nutzen?
          </h2>
